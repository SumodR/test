...
class _HomeScreenState extends State<HomeScreen>
  ...
  fetchData() async {
    ...
    String url =
        "https://07b1-2402-3a80-1e7f-7a89-898d-6ec8-eade-9732.ngrok-free.app/api?query=${_currentPosition!.latitude}|${_currentPosition!.longitude}";

    print('heelelelleleleololololo');
    // String url1 =
